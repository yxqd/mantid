#ifndef MANTID_ALGORITHM_ChopAndReducePowder_H_
#define MANTID_ALGORITHM_ChopAndReducePowder_H_
...
*/
class DLLExport ChopAndReducePowder : public API::DataProcessorAlgorithm {
public:
  /// Constructor
  ChopAndReducePowder() : API::DataProcessorAlgorithm() {}
  /// Destructor
  ~ChopAndReducePowder() override {}

  /// Algorithm's name for identification overriding a virtual method
  const std::string name() const override { return "ChopAndReducePowder"; }
...
private:
  ...
  ChopWorkspace(const std::string &ws_group_name);

  void ReduceChoppedPowderData(const std::vector<std::string> &ws_name_vector);
  API::MatrixWorkspace_sptr RebinWorkspace(const std::string &ws_name);
  API::MatrixWorkspace_sptr
  CompressEventsInWorkspace(API::MatrixWorkspace_sptr matrix_ws);
  API::MatrixWorkspace_sptr AlignDetectors(API::MatrixWorkspace_sptr matrix_ws);
  ...
  DataObjects::EventWorkspace_sptr m_inputW;
...
#endif /*MANTID_ALGORITHM_ChopAndReducePowder_H_*/
