...
public:
  ...
  void test_commonBoundaries() {
    ...
    singlespectrum->init(HistogramData::Histogram::YMode::Counts, 1, 6, 5);
    ...
    ws->init(HistogramData::Histogram::YMode::Counts, 5, 6, 5);
    ...
    ws2->init(HistogramData::Histogram::YMode::Counts, 2, 6, 5);
    ...
    ws3->init(HistogramData::Histogram::YMode::Counts, 2, 3, 2);
    ws3->dataX(0)[0] = -1;
    ws3->dataX(0)[2] = 0;
  ...
  {
    auto ws = boost::make_shared<WorkspaceTester>();
    ws->init(HistogramData::Histogram::YMode::Counts, 2, 2, 1);
  ...
  void test_matchingBins() {
    ...
    auto ws2 = boost::make_shared<WorkspaceTester>();
    ws2->init(HistogramData::Histogram::YMode::Counts, 3, 2, 1);
    auto ws3 = boost::make_shared<WorkspaceTester>();
    ws3->init(HistogramData::Histogram::YMode::Counts, 2, 3, 2);
    ...
    ws4->init(HistogramData::Histogram::YMode::Counts, 2, 3, 2);
    ws4->dataX(0)[0] = -1;
    ws4->dataX(0)[1] = 0;
    auto ws5 = boost::make_shared<WorkspaceTester>();
    ws5->init(HistogramData::Histogram::YMode::Counts, 2, 3, 2);
    ws5->dataX(0)[0] = -1;
    ws5->dataX(0)[2] = 0;
    TS_ASSERT(!WorkspaceHelpers::matchingBins(ws4, ws5, true))
    auto ws6 = boost::make_shared<WorkspaceTester>();
    ws6->init(HistogramData::Histogram::YMode::Counts, 2, 3, 2);
    ws6->dataX(1)[0] = -1;
    ws6->dataX(1)[1] = 0;
    auto ws7 = boost::make_shared<WorkspaceTester>();
    ws7->init(HistogramData::Histogram::YMode::Counts, 2, 3, 2);
    ws7->dataX(1)[0] = -1;
    ws7->dataX(1)[2] = 0;
  ...
  void test_matchingBins_negative_sum() // Added in response to bug #7391
  {
    ...
    ws1->init(HistogramData::Histogram::YMode::Counts, 2, 2, 1);
    ws1->getSpectrum(1).dataX()[0] = -2.5;
    ws1->getSpectrum(1).dataX()[1] = -1.5;

    auto ws2 = boost::make_shared<WorkspaceTester>();
    ws2->init(HistogramData::Histogram::YMode::Counts, 2, 2, 1);
