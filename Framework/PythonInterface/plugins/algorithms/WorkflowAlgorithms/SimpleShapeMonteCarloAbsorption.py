...
from mantid.simpleapi import AddSampleLogMultiple, MonteCarloAbsorption, SetBeam, SetSample
...
class SimpleShapeMonteCarloAbsorption(DataProcessorAlgorithm):
    ...
    def PyExec(self):
        ...
        SetBeam(InputWorkspace=self._input_ws, Geometry={'Shape' : 'Slit',
                                                         'Width' : self._beam_width,
                                                         'Height' : self._beam_height},
                EnableLogging=False)

        sample_geometry = self._sample_geometry
