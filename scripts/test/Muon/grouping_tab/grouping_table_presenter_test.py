...
class GroupingTablePresenterTest(unittest.TestCase):
    ...
    def test_context_menu_add_grouping_with_no_rows_selected_adds_group_to_end_of_table(self):
        ...
        QtGui.QCursor.setPos(self.view.grouping_table.pos())
    ...
    def test_context_menu_remove_grouping_with_no_rows_selected_removes_last_row(self):
        ...
        self.assertEqual(len(self.model.groups), 2)
        self.assertEqual(self.view.num_rows(), 2)
        self.assertEqual(self.view.get_table_item_text(0, 0), "group_0")
        self.assertEqual(self.view.get_table_item_text(1, 0), "group_1")
    ...
    def test_that_default_group_name_is_group_0(self):
        ...
        self.assertEqual(str(self.view.get_table_item_text(0, 0)), "group_0")
        self.assertIn("group_0", self.model.group_names)
    ...
    def test_that_adding_new_group_creates_incremented_default_name(self):
        ...
        self.assertEqual(str(self.view.get_table_item_text(0, 0)), "group_0")
        self.assertEqual(str(self.view.get_table_item_text(1, 0)), "group_1")
        self.assertEqual(str(self.view.get_table_item_text(2, 0)), "group_2")
        six.assertCountEqual(self, self.model.group_names, ["group_0", "group_1", "group_2"])
